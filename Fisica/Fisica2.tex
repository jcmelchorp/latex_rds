...
\begin{boxF}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=0.4\linewidth]{tierra.jpg}
    \label{fig:tierra}
  ...
  el Voyager 1 tomó una foto de la Tierra que la nasa publicó con el
  t\'itulo de \emph{Un punto azul pálido}.
...
\begin{boxF}
  \begin{center}\textbf{\large Cierre}\end{center}
