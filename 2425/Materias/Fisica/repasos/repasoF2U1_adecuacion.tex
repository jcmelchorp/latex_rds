...
\begin{questions}%\large
	...
	\questionboxed[7]{Relaciona las magnitudes físicas fundamentales con su unidad de medida en el Sistema Internacional.
	...
	\questionboxed[15]{Analiza las siguientes afirmaciones. Luego, escribe un V si es verdadero o una F si es falsa.
	...
	\questionboxed[10]{Elige la respuesta correcta.
	...
	\questionboxed[9]{Selecciona la respuesta correcta:
	...
	\questionboxed[15]{Relaciona los conceptos de la columna izquierda con su descripción en la columna derecha:
	...
	\questionboxed[14]{Señala si los siguientes procesos son \textit{físicos} o \textit{químicos}.
