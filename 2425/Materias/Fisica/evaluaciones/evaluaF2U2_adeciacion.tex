...
\begin{questions}
	\question[12]{Señala si son \textit{verdaderas} o \textit{falsas} las siguientes frases:
	...
	\question[4]{Elige la respuesta para cada pregunta, a partir de las imágenes de la figura \ref{fig:camiones3}.

		\begin{multicols}{2}
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.75\linewidth]{camiones3.png}
...
\question[16]{\include*{../questions/question034}}
	...
	\question[18]{Coloca los conceptos en el lugar que les corresponda en la imagen.\\
		...
		\begin{minipage}[b][][b]{.75\textwidth}
			\ifprintanswers{
	...
	\question[18]{Coloca los conceptos en el lugar que les corresponda en la imagen.
		...
		\begin{minipage}[t][][b]{.3\textwidth}\Large
