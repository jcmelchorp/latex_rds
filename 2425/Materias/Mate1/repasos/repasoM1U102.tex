...
\begin{questions}
  ...
  \subsection*{\ifprintanswers{Fracciones equivalentes}\else{}\fi}
      ...
      \questionboxed[4]{Escribe el número que representa el punto indicado en la recta numérica de cada uno de los siguientes incisos.
            ...
            \begin{multicols}{3}
                  \begin{parts}
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-182.png} \\[-1em]   \fillin[$-182$][1.5in]
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-3.9.png} \\[-1em]  \fillin[$-3.9$][1.5in]
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-2.png}   \\[-1em]  \fillin[$-2$][1.5in]
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-6.png}   \\[-1em]  \fillin[$-6$][1.5in]
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-23.png}  \\[-1em]  \fillin[$-23$][1.5in]
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-83.png}  \\[-1em]  \fillin[$-83$][1.5in]
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-171.png} \\[-1em]   \fillin[$-171$][1.5in] 
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-3.1.png} \\[-1em]   \fillin[$-3.1$][1.5in] 
                        \part \includegraphics[width=\linewidth]{../images/recta_num_-6.png}   \\[-1em] \fillin[$-6$][1.5in]     
                  \end{parts}
            \end{multicols}
      }
