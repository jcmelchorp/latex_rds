...
\begin{questions}
      ...
      \questionboxed[4]{Escribe el número que representa el punto indicado en la recta numérica de cada uno de los siguientes incisos.
            ...
            \begin{multicols}{2}
                  \begin{parts}
                        ...
                        \part \includegraphics[width=150px]{../images/recta_num_8.9.png}  \\[-0.5em]  \fillin[$8.9$][1.5in]
                        \part \includegraphics[width=150px]{../images/recta_num_8.97.png} \\[-0.5em]  \fillin[$8.97$][1.5in]
                        \part \includegraphics[width=150px]{../images/recta_num_2.05.png} \\[-0.5em]  \fillin[$2.05$][1.5in]
                  \end{parts}
            \end{multicols}
      }
      ...
      \questionboxed[4]{Escribe el número decimal que representa cada porcentaje:
            ...
            \begin{multicols}{2}
                  \begin{parts}
                        \part Convierte 50\% a un número decimal. \fillin[$0.5$][0in]
                        \part Convierte 25\% a un número decimal. \fillin[$0.25$][0in]
                        \part Convierte 12\% a un número decimal. \fillin[$0.12$][0in]
      ...
      \questionboxed[4]{Escribe el número que representa el punto indicado en la recta numérica de cada uno de los siguientes incisos.
            ...
            \begin{multicols}{2}
                  \begin{parts}
                        ...
                        \part \includegraphics[width=150px]{../images/recta_num_-2.png}  \\[-0.5em]  \fillin[$-2$][1.5in]
                        \part \includegraphics[width=150px]{../images/recta_num_-6.png} \\[-0.5em]  \fillin[$-6$][1.5in]
                        \part \includegraphics[width=150px]{../images/recta_num_-23.png} \\[-0.5em]  \fillin[$-23$][1.5in]
                        \part \includegraphics[width=150px]{../images/recta_num_-83.png} \\[-0.5em]  \fillin[$-83$][1.5in]
                  \end{parts}
            \end{multicols}
      }
