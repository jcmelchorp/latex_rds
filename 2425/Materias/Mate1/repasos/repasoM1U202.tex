...
\begin{questions}
	...
	\questionboxed[5]{ Realiza las siguientes sumas de decimales:
		...
		\begin{multicols}{5}
			\begin{parts}
				\part \opadd[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{16.981}{15.891}\\[1em]
				\part \opadd[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{620.64}{515.92}\\[1em]
				\part \opadd[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{24.97}{19.34}\\[1em]
				\part \opadd[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{509.44}{338.79}\\[1em]
				\part \opadd[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{33.31}{19.54}\\[1em]
			\end{parts}
		\end{multicols}
	...
	\questionboxed[5]{ Realiza las siguientes restas de decimales:
		...
		\begin{multicols}{3}
			\begin{parts}
				\part \opsub[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{55.394}{49.093}\\[1em]
	...
	\questionboxed[5]{ Realiza las siguientes sumas y restas de fracciones con denominadores iguales:
		\begin{multicols}{3}
			\begin{parts}
				\part $\dfrac{3}{5}+\dfrac{2}{5}=$ \fillin[$\dfrac{5}{5}=1$][1in]\\[1em]
				\part $\dfrac{7}{8}-\dfrac{3}{8}=$ \fillin[$\dfrac{5}{8}$][1in]\\[1em]
				\part $\dfrac{37}{12}-\dfrac{11}{12}=$ \fillin[$\dfrac{13}{6}=1$][1in]\\[1em]
				\part $\dfrac{7}{4}+\dfrac{3}{4}=$ \fillin[$\dfrac{}{}+\dfrac{}{}=\dfrac{}{}$][1in]\\[1em]
				\part $\dfrac{1}{3}+\dfrac{2}{3}=$ \fillin[$\dfrac{}{}+\dfrac{}{}=\dfrac{}{}$][1in]\\[1em]
				\part $\dfrac{5}{4}+\dfrac{8}{4}=$ \fillin[$\dfrac{}{}+\dfrac{}{}=\dfrac{}{}$][1in]\\[1em]
			\end{parts}
		\end{multicols}
	}
	...
	\questionboxed[5]{ Realiza las siguientes sumas y restas de fracciones con denominadores diferentes:
		\begin{multicols}{3}
			\begin{parts}
				\part $\dfrac{3}{5}+\dfrac{2}{3}=$ \fillin[$\dfrac{9}{15}+\dfrac{10}{15}=\dfrac{19}{15}$][1in]\\[1em]
				\part $\dfrac{7}{8}+\dfrac{3}{4}=$ \fillin[$\dfrac{7}{8}+\dfrac{6}{8}=\dfrac{13}{8}$][1in]\\[1em]
				\part $\dfrac{2}{3}-\dfrac{1}{6}$ \fillin[$\dfrac{2}{3}-\dfrac{1}{6} =\dfrac{1}{2}$][1in]\\[1em]
				\part $\dfrac{5}{6}-\dfrac{3}{8}$ \fillin[$\dfrac{5}{6}-\dfrac{3}{8} =\dfrac{11}{24}$][1in]\\[1em]
				\part $\dfrac{4}{5}-\dfrac{3}{10}$ \fillin[$\dfrac{4}{5}-\dfrac{3}{10} =\dfrac{1}{2}$][1in]\\[1em]
				\part $\dfrac{1}{3}-\dfrac{1}{5}$ \fillin[$\dfrac{1}{3}-\dfrac{1}{5} = \dfrac{2}{5}$][1in]\\[1em]
			\end{parts}
		\end{multicols}
	}
	...
	\questionboxed[5]{ Realiza las siguientes multiplicaciones de fracciones:
		\begin{multicols}{3}
			...
			\part $\dfrac{4}{9}\times 2$ \fillin[$\dfrac{4}{9}\times 2=\dfrac{8}{9}$][1in]\\[1em]
			\part $\dfrac{4}{3}\times\dfrac{7}{8}$ \fillin[$\dfrac{4}{3}\times\dfrac{7}{8}=\dfrac{7}{6}$][1in]\\[1em]
			\part $3\dfrac{5}{8}\times2\dfrac{8}{9}$ \fillin[$3\dfrac{5}{8}\times2\dfrac{8}{9}=\dfrac{377}{36}$][1in]\\[1em]
			\part $\dfrac{9}{5}\times\dfrac{15}{4}$ \fillin[$\dfrac{9}{5}\times\dfrac{15}{4}=\dfrac{27}{4}$][1in]\\[1em]
        \end{parts}
		\end{multicols}
	}

	\subsection{División de fracciones}
	\questionboxed[5]{ Realiza las siguientes divisiones de fracciones:
		\begin{multicols}{3}
			\begin{parts}
				\part $ \dfrac{3}{5} \divisionsymbol\dfrac{2}{3}=$ \fillin[$\dfrac{9}{10}$][1in]\\[1em]
				\part $ \frac{7}{12}\divisionsymbol\frac{2}{3}=$ \fillin[$\dfrac{7}{8}$][1in]\\[1em]
			\part $$ \fillin[][]
