...
\begin{questions}
    ...
    \questionboxed[4]{ Realiza las siguientes operaciones de decimales:

        \begin{multicols}{2}
            \begin{parts}
                \part \ifprintanswers{\large \quad \opadd[hfactor=decimal,resultstyle=\color{red},carryadd=true,carrysub=false]{24.97}{19.34} \\[3em]}
                \else{          \large \quad \opadd[hfactor=decimal,resultstyle=\color{white},carryadd=false,carrysub=false]{24.97}{19.34} \\[3em]}
                \fi

                \part \ifprintanswers{\large  \quad  \opsub[hfactor=decimal,resultstyle=\color{red},carrysub=true]{968.31}{134.67} \\[1ex]}
                \else{          \large  \quad  \opsub[hfactor=decimal,resultstyle=\color{white},carrysub=false]{968.31}{134.67} \\[1ex]}
                \fi
                \columnbreak%

                \part \ifprintanswers{ \quad \opmul[hfactor=decimal,resultstyle=\color{red},displayintermediary=all]{198.4}{12.2} \\[4em]}
                \else{          \large \quad \opmul[hfactor=decimal,resultstyle=\color{white},displayintermediary=None]{198.4}{12.2} \\[4em]}
                \fi

                \part \ifprintanswers{\large\opdiv[period,style=text,hrulewidth=0.2pt,vruleperiod=0.7,hfactor=decimal,resultstyle=\color{red}]{8.32}{1.2}}
                \else{          \large  \quad $1.2 \overline{) \ 8.32 \ }$}
                \fi
            \end{parts}
        \end{multicols}
    }
    ...
    \questionboxed[4]{ Realiza las siguientes operaciones con fracciones:
    ...
    \questionboxed[3]{ Escribe como decimal los siguientes porcentajes:
    ...
    \questionboxed[3]{ Escribe como porcentaje los siguientes decimales:
    ...
    \questionboxed[6]{ Calcula el porcentaje de las siguientes cantidades:
    ...
    \questionboxed[2]{ Determina el signo \textit{positivo} o \textit{negativo} que resulta de las siguientes operaciones:
        \begin{multicols}{2}
            \begin{parts}
    ...
    \questionboxed[2]{ Realiza las siguientes operaciones con números negativos:
        \begin{multicols}{2}
            \begin{parts}
    ...
    % \questionboxed[6]{ María y Jorge tienen 45 bolas blancas, 15 bolas azules y 90 bolas rojas y quieren hacer el mayor número de collares iguales sin que sobre ninguna bola. ¿Cuántos collares iguales pueden hacer?
    % \begin{solutionbox}{4cm}
    ...
    \questionboxed[2]{ Realiza las siguientes operaciones con múltiplos de 10:
    ...
    \questionboxed[2]{ Convierte las siguientes fracciones a decimales:
        \begin{multicols}{2}
            \begin{parts}
    ...
    \subsection*{\ifprintanswers{Ubicación en la recta numérica}\else{}\fi}
    \questionboxed[2]{ Escribe el número que representa el punto indicado en la recta numérica de cada uno de los siguientes incisos.
