...
\begin{questions}\large
	...
	\begin{multicols}{2}
		\begin{parts}
			\part Encuentra el máximo común divisor de 120 y 300. \fillin[$\text{mcd}(33,121)=11$][0in]

			\begin{solutionbox}{2cm}

			\end{solutionbox}

			\part Encuentra el mínimo común múltiplo de 12, 15 y 18. \fillin[$\text{mcm}(2,3,4)=12$][0in]
			\begin{solutionbox}{2cm}
			\end{solutionbox}
