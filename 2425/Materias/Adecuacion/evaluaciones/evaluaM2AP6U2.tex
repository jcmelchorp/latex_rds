...
\question[10]{Observa los siguientes \'angulos y estima la medida en cada inciso.
...
\question[5]{Escribe sobre la línea el nombre que recibe cada figura geométrica de acuerdo con su número de lados:
...
\question[5]{Clasifica las siguientes fracciones en propias, impropias o mixtas:
...
\question[5]{Escribe sobre la línea la fracción que representa cada imagen:
...
\question[5]{Escribe los siguientes porcentajes como números decimales:
...
\question[5]{Convierte los siguientes números decimales a una fracción:
