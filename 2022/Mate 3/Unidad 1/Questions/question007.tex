\question[10] En la figura \ref{fig:triang_sem05} $\overline{RA}$ es paralelo a $\overline{ET}$ ($\overline{RA}\parallel\overline{ET}$) y la longitud de $RT$ es $21$ unidades.
