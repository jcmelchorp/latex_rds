...
\begin{questions}
  \question[15] Analiza la figura \ref{fig:lados_sem03} y encuentra la medida de $x$.
  ...
  \question[15] Realiza la siguiente multiplicaci\'on de expresiones algebraicas.
