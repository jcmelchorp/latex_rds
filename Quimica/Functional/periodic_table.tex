...
\newcommand{\TablaPeriodica}[1][0.55]{
    \begin{tikzpicture}[font=\sffamily,scale=#1, transform shape]
        ...
        % Group 6 - VIB
        \node[right of=V, Metal] (Cr) {\NaturalElem{24}{51.996}{Cr}{Chromio}};
        ...
        \node[below of=Mn, Metal] (Tc) {\NaturalElem{43}{96}{Tc}{Technetio}};
        \node[below of=Tc, Metal] (Re) {\NaturalElem{75}{186.21}{Re}{Rhenio}};
        ...
        \node[below of=Co, Metal] (Rh) {\NaturalElem{45}{102.91}{Rh}{Rhodio}};
        ...
        \node[right of=Pr, LanthanideActinide] (Nd) {\NaturalElem{60}{144.24}{Nd}{Neodymio}};
        \node[right of=Nd, LanthanideActinide] (Pm) {\NaturalElem{61}{145}{Pm}{Promethio}};
        ...
        \node[right of=Tb, LanthanideActinide] (Dy) {\NaturalElem{66}{162.50}{Dy}{Dysprosio}};
        ...
        \node[right of=Er, LanthanideActinide] (Tm) {\NaturalElem{69}{168.93}{Tm}{Thulio}};
        \node[right of=Tm, LanthanideActinide] (Yb) {\NaturalElem{70}{173.04}{Yb}{Ytterbio}};
        \node[right of=Yb, LanthanideActinide] (Lu) {\NaturalElem{71}{174.97}{Lu}{Lutetio}};

        % Actinide
        \node[below of=La, LanthanideActinide, yshift=-1cm] (Ac) {\NaturalElem{89}{227}{Ac}{Actinio}};
        \node[right of=Ac, LanthanideActinide] (Th) {\NaturalElem{90}{232.04}{Th}{Thorio}};
