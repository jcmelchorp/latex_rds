...
después fueron sílabas, después palabras completas hasta poder llegar a los enunciados y dentro de los enunciados vienen los signos de puntuación, las comas, los dos puntos, el punto y seguido, el punto aparte, etc. Y entendiste la importancia de los signos de puntuación.
...
\begin{enumerate}
  ...
  \item  Para llenar un vitrolero se necesitan cuatro litros de agua. Completa la tabla para
        ...
        \begin{figure}[H]
          \centering
          \includegraphics[width=0.5\linewidth]{Hombre-de-Vitruvio.jpg}
          \captionof{table}{}
  ...
  \item Durante el Renacimiento, el estudio de la anatomía humana tuvo gran auge. Uno
        de los trabajos más conocidos es El hombre de Vitrubio (ver figura \ref{fig:Hombre-de-Vitruvio}) de Leonardo
        ...
        \begin{enumerate}
          \begin{figure}[H]
            \centering
            \includegraphics[width=0.5\linewidth]{tabla_hombre.png}
          \end{figure}
