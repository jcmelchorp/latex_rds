...
%  colback      = rdsColor!20!white,
  ...
  colframe     = rdsColor,
  fonttitle    = \sffamily,
  colbacktitle = rdsColor!65!white,
  boxrule=0.4pt,
  arc=2pt,
  boxsep=0mm,
  title        = #2,#1,
...
\newcommand{\planner}[3]{%
    ...
    \def\unitinfo{\RaggedRight%
        \tcbox[colback=rdsColor!5!white,colframe=rdsColor,size=fbox,on line]{\large {\sffamily Unidad} #3}
    }
...
\newcommand{\itembox}{
    \tcbox[size=fbox,on line,colback=orange!10!white]{\JSONParseArrayValue}
}
...
\newcommand*\planTitle[8]{\small%
    ...
    \begin{tabularx}{0.7\textwidth}{rYr}
        ...
        & & \tcbox[colback=yellow!20!white,colframe=rdsColor,size=fbox,on line]{\large {\sffamily Semana} {\bfseries #6}} \tcbox[colframe=rdsColor,size=fbox,on line]{ {\Large #5} \begin{minipage}[b]{1cm}\sffamily\tiny Períodos\\lectivos\end{minipage}}  \\
...
\begin{tcolorbox}[titlebox,title=\RaggedLeft\planTitle
        ...
        \weekcontents%
         ...
         \begin{minipage}[t][12.5cm][b]{0.27\linewidth}
            \JSONParseArrayMapFunction[
                ...
                code after={\end{titlebox}}
                    ...
                    \begin{notasbox}
                        ...
                        \tcblower
                        {\vspace{2mm} \hfill \\ \hfill \\ \hfill \\ \hfill \\ \hfill \\ \hfill \\ \hfill \\ \hfill \\ \hfill \\ \hfill }
                    \end{notasbox}\vfill
