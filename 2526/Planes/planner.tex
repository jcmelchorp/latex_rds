...
\newcommand*\planTitle[8]{\small%
    ...
    \begin{tabularx}{0.7\textwidth}{rYr}
        {\sffamily Campo formativo:} & Saberes y Pensamiento Científico  &  \tcbox[colback=red!10!white,colframe=rdsColor,size=fbox,on line]{\large 2025-2026} \unitinfo  \\ 
        {\sffamily Tema:}  & \multirow[t]{2}{\linewidth}{#3} & \rangofecha{#7}{#8} \\
        & & \tcbox[enhanced,colback=yellow!20!white,colframe=rdsColor,size=fbox,on line]{ {\large\sffamily Semana} {\Large #6}} \tcbox[colframe=rdsColor,size=fbox,on line]{ {\Large #5} \begin{minipage}[b]{1cm}\sffamily\tiny Períodos\\lectivos\end{minipage}}  \\
...
\NewDocumentCommand{\badges}{ m m }{
    ...
    \begin{tcolorbox}[infobox,size=normal,boxrule=0.4pt,left=1mm,right=1mm,top=1mm,bottom=1mm, title={\sffamily  Vinculación del campo formativo:}]
        \tcboxfit[colback=white,colframe=white,top=0mm,bottom=0mm,left=0mm,right=0mm,height=1.2cm]{#1}
    \end{tcolorbox}
}

% \NewDocumentCommand{\weekcontents}{ m m m }{%
% %\newcommand{\weekcontents}[8]{%
% \begin{minipage}[t][12.5cm][b]{0.74\linewidth}
%     \tcbsubtitle{INICIO}
%     \tcboxfit[colback=white,colframe=white,top=0mm,bottom=0mm,left=0mm,right=10pt,height=2.6cm]{#1}
%     \tcbsubtitle{DESARROLLO}
%     \tcboxfit[colback=white,colframe=white,top=0mm,bottom=0mm,left=0mm,right=10pt,height=4.75cm]{#2}
%     \tcbsubtitle{CIERRE}
%     \tcboxfit[colback=white,colframe=white,top=0mm,bottom=0mm,left=0mm,right=10pt,height=2.25cm]{#3}
% \end{minipage}
% }
        ...
        \weekcontents%
         ...
         \begin{minipage}[t][12.5cm][b]{0.29\linewidth}
            ...
            \JSONParseArrayMapFunction[
                code before={\begin{activitybox}{Actividades}\centering\large},
            ...
            {%
            \JSONParseArrayMapFunction[
                code before={\begin{itemize}[leftmargin=5pt,itemsep=0pt,itemindent=0em]},
                code after={\end{itemize}}
            ]{\weekdata}{weeks[#1].Libros}{\itemitemize}%
            }
    \end{minipage}
\end{tcolorbox}
\weekbottom
    ...
    {%
            \JSONParseArrayMapFunction[
                code before={\begin{itemize}[leftmargin=5pt,itemsep=0pt,itemindent=0em]},
                code after={\end{itemize}}
            ]{\weekdata}{weeks[#1].EvaluacionFormativa}{\itemitemize}
    }
}
\end{document}