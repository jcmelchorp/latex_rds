...
%         % second row: calendar
%          \calperiod{2025-09-01}{2025-09-30} & \calperiod{2025-10-01}{2025-10-31} & \calperiod{2025-11-01}{2025-11-30} %
%     };
% \end{tikzpicture}
% }
  }{}%
...
\newcommand{\calperiod}[2][\currentyear]{%
  \calendar[dates=\currentyear-#2-01 to \currentyear-#2-last]
    if (Sunday) [yellow] \holidays;}
\edef\currentyear{\the\year}
\newcommand{\holidays}{% holidays in Italy
if (equals=01-01) [yellow]%
if (equals=01-06) [yellow]%
if (equals=04-04) [yellow]%
if (equals=04-05) [yellow]%
if (equals=04-25) [yellow]%
if (equals=05-01) [yellow]%
if (equals=05-01) [yellow]%
if (equals=06-02) [yellow]%
if (equals=08-15) [yellow]%
if (equals=11-01) [yellow]%
if (equals=12-08) [yellow]%
if (equals=12-25) [yellow]%
if (equals=12-26) [yellow]%
}
