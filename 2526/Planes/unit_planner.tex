...
\newcommand{\planner}[3]{%
    ...
    \def\schoolinfounit{\RaggedRight%
        ...
        {\color{gray!40!black}\scriptsize\sffamily 30PES0329R \hspace{0.3\linewidth} turno matutino }\\[0.2em]
...
\def\studentTitle{%
    ...
    \begin{tabularx}{0.57\textwidth}{rYr}
         {\sffamily Disciplina:} & {\disciplina} &  {\large\unitinfo}  \\ 
         {\sffamily Grado y grupo:} & {\gradogrupo} &  {\large\cicloescolar} \\ 
         \cline{2-3}
...
% \planner{2}{math}{1}%
\planner{3}{math}{1}%
%  \planner{3}{chem}{1}% !!   11pt, landscape !!!!
% \planner{2}{phys}{2}%
