...
\newcommand{\rangofecha}[2]{
    \begin{tikzpicture}[baseline]
        ...
        \node[black] at ([xshift=-0.8cm]box.center) {#1};
        \node[black] at ([xshift=0.8cm]box.center) {#2};
    \end{tikzpicture}%
}
...
\newcommand{\planner}[3]{%
    ...
    \def\schoolinfo{\RaggedRight%
        ...
        {\color{green!20!black} \fontsize{12}{12}\selectfont \sffamily Autocontrol del alumno}\\
...
%\planner{3}{math}{1}%
 %\planner{3}{chem}{3}%
\planner{2}{phys}{2}%
    \begin{tcolorbox}[titlebox,title=\studentTitle]
        \begin{multicols}{2}
        ...
        \begin{tcolorbox}[infobox,title={\rangofecha{\JSONParseValue{\weekdata}{weeks[#1].FechaDeInicio}}{\JSONParseValue{\weekdata}{weeks[#1].FechaDeCierre}} \ Semana \textbf{\JSONParseValue{\weekdata}{weeks[#1].SemanaEscolar}} \JSONParseValue{\weekdata}{weeks[#1].Tema}}]
            \arrayitemize{#1}{Worklist}
