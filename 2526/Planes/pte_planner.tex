...
\newcommand*\booknode[1]{\tikz[baseline=(char.base)]{
                                \node[shape=rounded rectangle,draw=rdsColor,rounded rectangle east arc=concave,text=black!80,fill=white,xshift=-0.6em,yshift=-2pt,scale=1,drop shadow={opacity=0.4,shadow xshift=2.5pt,shadow yshift=-1pt}] (char) {#1};}}
...
\newtcolorbox{subsectionbox}[1][]{%
    ...
    sharp corners=south,
    fontupper=\color{gray!50}\bfseries\sffamily,%\RaggedLeft,
    #1,
    % on line,
    enhanced,
}
...
\booknode{\JSONParseValue{\weekdata}{weeks[#1].SemanaEscolar}}\,\rangofechas{\fechainicio}{\fechacierre}\,\JSONParseValue{\weekdata}{weeks[#1].Tema} \hfill
\periodoslectivos{#1}%  
}
...
% \end{multicols}
    \begin{subsectionbox}%\shadowoffset{1pt}
        \shadowtext{Calendario de la unidad}
    \end{subsectionbox}
