...
\begin{questions}
     \questionboxed[5]{Coloca los conceptos en el lugar que les corresponda en la imagen.\\
          ...
          \begin{center}
               \wordpill[olive]{Sublimación}
               \wordpill[olive]{Fusión}
               \wordpill[olive]{Ebullición}
               \wordpill[olive]{Sólido}
               \wordpill[olive]{Líquido}
               \wordpill[olive]{Gaseoso}
               \wordpill[olive]{Solidificación}
               \wordpill[olive]{Condensación}
               \wordpill[olive]{Deposición}
               \vspace*{1em}
     ...
     \questionboxed[5]{Coloca las palabras que completan los párrafos.\\
          \begin{center}
               \wordpill[olive]{empírico}
               \wordpill[olive]{argumentación}
               \wordpill[olive]{científico}
               \wordpill[olive]{asistemático}
               \wordpill[olive]{religioso}
               \wordpill[olive]{ciencia}
               \wordpill[olive]{sistematizado}
               \wordpill[olive]{Galileo Galilei}
               \wordpill[olive]{razón}
               \wordpill[olive]{método científico}
               \wordpill[olive]{los cráteres de la Luna}
          \end{center}
          \vspace*{1em}
          \begin{parts}
     ...
     \questionboxed[5]{Coloca los conceptos en el lugar que les corresponda en la imagen.\\
          ...
          \begin{center}
               \wordpill[olive]{Mecánica estadiática}
               \wordpill[olive]{Estudia los átomos y su constitución}
               \wordpill[olive]{Relatividad}
               \wordpill[olive]{Fuerza}
               \wordpill[olive]{Describe el movimiento de los objetos}
               \wordpill[olive]{Física clásica}
               \wordpill[olive]{Física moderna}
               \wordpill[olive]{Calor y temperatura}
               \vspace*{1em}
     ...
     \questionboxed[10]{Coloca los conceptos en el lugar que les corresponda en la imagen.\\
          ...
          \begin{center}
               \wordpill[olive]{Modelo atómico del ``panqué con pasas''}
               \wordpill[olive]{El descubrimiento del electrón}
               \wordpill[olive]{Ernest Rutherford}
               \wordpill[olive]{El descubrimiento del núcleo atómico}
               \wordpill[olive]{Neutrones}
               \wordpill[olive]{Niels Bohr}
               \wordpill[olive]{Modelo Cuántico del átomo}
               \wordpill[olive]{Explicar los espectros luminosos}
               \wordpill[olive]{Descubrir el átomo de hidrógeno}
               \vspace*{1em}
