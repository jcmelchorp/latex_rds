 Escribe las palabras que completan las afirmaciones.
    \begin{parts}
        ...
        \part El corrimiento al rojo permitió a Hubble determinar que la \fillin[velocidad][2cm]
        con la que se alejan las galaxias es proporcional a la \fillin[distancia][2cm] a la que se encuentran. (pág. \pageref{086b_b})

        \part La interpretación que se le dio al descubrimiento de \fillin[Hubble][2cm] es que el Universo se expande. (pág. \pageref{086b_c})
    \end{parts}