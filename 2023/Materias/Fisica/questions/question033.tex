...
\begin{parts}
    ...
    \part[5] El estado rmal de los objetos, a excepción de los objetos celestes, es el de reposo.
    ...
    \part[5] Un objeto que está en su lugar propio  se mueve, a mes que se le someta a una fuerza.
