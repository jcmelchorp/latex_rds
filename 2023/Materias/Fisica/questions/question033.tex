...
\begin{parts}
    ...
    \part El estado normal de los objetos, a excepción de los objetos celestes,
    es el de reposo.
    ...
    \part Un objeto que está en su lugar propio  se mueve, a menos que se le
    someta a una fuerza.
    ...
    \part Los cuerpos celestes siguen leyes del movimiento distintas a la de
    ...
    \part Una flecha se mueve a causa de la brecha en el aire originada por su
    movimiento. La brecha en el aire causa un efecto de apriete en la parte trasera
    de la flecha a medida que el aire regresa para evitar que se forme el vacío.
    ...
    \part Todo cuerpo tiende a mantener su estado de reposo o de movimiento en
    línea recta con velocidad constante, a mes que una fuerza que actúe sobre él le
