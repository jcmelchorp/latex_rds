...
\begin{parts}
    ...
    % \part ¿De qué longitud tendrá que ser el plano inclinado por utilizar si deseas
    ...
    % \part ¿A qué altura se subió un objeto de 84 N si se aplicó una fuerza de 18 N y
    ...
    \part ¿Qué fuerza se debe aplicar a una caja de 679 N de peso para subirla a
    ...
    % \part Se necesita subir una carga de 500 kg (4900 N) a una altura de 1.5 m
