...
\ifprintanswers{
      \includegraphics[width=.6\textwidth]{../images/SINFI_U2_AC47_IMG1_SOL.png}
}\else{
      \includegraphics[width=.6\textwidth]{../images/SINFI_U2_AC47_IMG1.png}
}\fi\hfill%
...
\begin{minipage}[t][][t]{.95\textwidth}
      \ifprintanswers{}\else{
            \wordpill{Modelo atómico del ``panqué con pasas''}
            \wordpill{Explicar los espectros luminosos}
            \wordpill{Neutrones} \wordpill{Niels Bohr}
            \wordpill[width=3cm]{El descubrimiento del núcleo atómico}
...
\begin{minipage}[t][][t]{.45\textwidth}
      \question[5] Ordena los pasos del método científico.
...
\end{minipage}\hfill%
\begin{minipage}[t][][t]{.45\textwidth}
\question[5] Relaciona las magnitudes físicas fundamentales con su unidad de medida en el Sistema Internacional.

\setlength{\columnsep}{1em}
\begin{multicols}{2}
      \raggedleft Cantidades Físicas \\

      \begin{parts}\raggedleft\small
            \part Masa                  \fillin[C][0.05in]
            \part Tiempo                \fillin[A][0.05in]
            \part Longitud              \fillin[E][0.05in]
            \part Temperatura           \fillin[B][0.05in]
            \part Corriente eléctrica   \fillin[D][0.05in]
            \part Intensidad luminosa   \fillin[F][0.05in]
            \part Cantidad de sustancia \fillin[G][0.05in]
      \end{parts}

      \columnbreak

      \raggedright Unidades SI \\
