...
\begin{parts}
    Explica bajo qué condiciones el número atómico permite deducir el número de electrones presentes en un
    átomo.
    ...
    % \begin{solutionbox}{3cm}
    % \end{solutionbox}
    En términos generales, el radio de un átomo es aproximadamente 10,000 veces mayor que su
