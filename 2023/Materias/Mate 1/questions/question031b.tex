    ...
    \begin{parts}
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|c|c|c|}
                ...
                4                                     & \ifprintanswers \$7 \fi     & \ifprintanswers$( 7 ,10)$\else( \quad,\quad )\fi \\\hline
                5                                     & \ifprintanswers \$8 \fi     & \ifprintanswers$( 8 ,11)$\else( \quad,\quad )\fi \\\hline
                6                                     & \ifprintanswers \$9 \fi     & \ifprintanswers$( 9 ,12)$\else( \quad,\quad )\fi \\\hline
                \bottomrule
            \end{tabular}
        \end{table}
        \columnbreak
