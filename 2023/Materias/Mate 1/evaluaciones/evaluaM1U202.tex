...
\begin{questions}
    ...
    \question[10] Realiza las siguientes sumas de decimales:
    \begin{multicols}{2}
        \begin{parts}
            \part \opadd[hfactor=decimal,resultstyle=\color{white},displayintermediary=None,carryadd=false,carrysub=false]{16.991}{15.981}
