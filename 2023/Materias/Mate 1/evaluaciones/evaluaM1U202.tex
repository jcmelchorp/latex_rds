...
=======
    ...
    \question[8]{ Realiza las siguientes operaciones de decimales:
        ...
        \begin{multicols}{2}
            \begin{parts}\large
                \part \opadd[hfactor=decimal,resultstyle=\color{white},carryadd=false,carrysub=false]{24.97}{19.34} \\[3em]

                \part \opsub[hfactor=decimal,resultstyle=\color{white}carrysub=false]{968.31}{134.67} \\[1ex]

                \columnbreak%

                \part \opmul[hfactor=decimal,resultstyle=\color{white},displayintermediary=None]{198.4}{12.2} \\[4em]

                \part $1.2 \overline{) \ 8.32 \ }$
    ...
    \begin{multicols}{3}
        \begin{parts}\large
            \part $2^3=$ \fillin[8][0in] \\[3em]

            \part $3^2=$ \fillin[9][0in]  \\[1em]

            \columnbreak%

            \part $10^4=$ \fillin[10000][0in] \\[3em]

            \part $\left(\dfrac{1}{3}\right)^3=$ \fillin[$\dfrac{1}{27}$][0in] \\[1em]

            \columnbreak%

            \part $\left(\dfrac{2}{3}\right)^4=$ \fillin[$\dfrac{16}{81}$][0in] \\[3em]

            \part $\left(\dfrac{4}{3}\right)^2=$ \fillin[$\dfrac{1}{1000}$][0in] \\[1em]
