...
\begin{enumerate}
    ...
    \item  Para llenar un vitrolero se necesitan cuatro litros de agua. Completa la tabla para
          ...
          \begin{figure}[H]
              \centering
              \includegraphics[width=0.6\linewidth]{../images/tabla_vitrolero.png}
              \captionof{table}{}
    ...
    \item Durante el Renacimiento, el estudio de la anatomía humana tuvo gran auge. Uno
          ...
          \begin{minipage}{0.45\textwidth}
              \begin{figure}[H]
                  \centering
                  \includegraphics[width=\linewidth]{../images/Hombre-de-Vitruvio.jpg}
          ...
          \begin{enumerate}
              \begin{figure}[H]
                  \centering
                  \includegraphics[width=0.6\linewidth]{../images/tabla_hombre.png}
              \end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=.7\linewidth]{../images/plano_sombras.png}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.6\linewidth]{../images/graficas_sombras.png}
        \captionof{figure}{}
