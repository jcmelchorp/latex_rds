...
\INFO%
% \section*{Sucesiones}
% \subsection*{Completa la sucesión aritmética 1}
...
\begin{questions}
      \questionboxed[5]{Escribe los términos faltantes de las siguientes sucesiones aritméticas:
      ...
      \questionboxed[6]{Encuentra el perímetro y el área de las siguientes figuras:
      ...
      \subsection*{Área lateral y total}
      \subsection*{Volumen}
