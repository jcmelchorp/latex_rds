...
\begin{questions}
      ...
      \question[4]{Responde a las siguientes preguntas:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[6]{Calcula el valor del ángulo $x$:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[6]{Calcula el valor del arco $x$:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[6]{Calcula el área de cada uno de los siguientes sectores circulares:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[4]{Resuelve las siguientes sumas de monomios y polinomios:
      ...
      \question[4]{Resuelve las siguientes operaciones convinadas:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[3]{Encuentra el perímetro de las siguientes figuras:
            \begin{multicols}{3}
                  \begin{parts}
                        \part \includegraphics[width=\linewidth]{mex_0030.png}\\
      ...
      \question[4]{Realiza la siguientes multiplicaciones de polinomios:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[5]{Convierte las siguientes unidades de longitud como se te pide:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[5]{Convierte las siguientes unidades de masa como se te pide:
            \begin{multicols}{2}
                  \begin{parts}
