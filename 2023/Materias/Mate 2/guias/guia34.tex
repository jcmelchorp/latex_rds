...
\begin{questions}
    ...
    \questionboxed[15]{\include*{../questions/question077j}}
    \ejemplosboxed[\include*{../questions/question077}]   
    \questionboxed[10]{\include*{../questions/question077l}}
    % \questionboxed[10]{\include*{../questions/question077k}}
    \ejemplosboxed[\include*{../questions/question077m}]
    \questionboxed[15]{\include*{../questions/question077e}}
    \ejemplosboxed[\include*{../questions/question077p}]
    %\questionboxed[5]{\include*{../questions/question077i}}
    \questionboxed[10]{\include*{../questions/question077h}}
    \questionboxed[10]{\include*{../questions/question077n}}
    \questionboxed[10]{\include*{../questions/question077o}}
    \questionboxed[10]{\include*{../questions/question077f}}
