...
\begin{parts}
    ...
    % \end{solutionbox}
    \part[5] ¿Cuál es la razón de cambio? ¿Cómo se relaciona ésta con la constante de proporcionalidad? ¿Cuál es? Explica su obtención.
    ...
    \part[5] Escribe una expresión algebraica que describa la situación. ¿Cuál es el valor de la pendiente y de la ordenada al origen? Describe su obtención:

    \begin{solutionbox}{2cm}

    \end{solutionbox}

    \part[5] ¿En cuántos días la sustancia activa queda totalmente eliminada del organismo del enfermo? Explica.
    ...
    \part[5] ¿Cómo es el tiempo que permanece en el cuerpo de un paciente, una sustancia activa
    ...
    \part[5] ¿Cómo es el tiempo que permanece en el cuerpo de un paciente, una sustancia activa de 4 mg que decae
    ...
    \part[5] ¿Cómo es el tiempo que permanece en el cuerpo de un paciente, una sustancia activa de 8 mg que decae 1 mg
    ...
    % \part[5] ¿Cómo es la razón de cambio de una sustancia activa de 8 mg en el cuerpo humano que decae 0.5 mg cada medio día con
    ...
    % \part[5] ¿Cómo es la razón de cambio de una sustancia activa de 8 mg en el cuerpo humano que decae 1 mg cada dos días
