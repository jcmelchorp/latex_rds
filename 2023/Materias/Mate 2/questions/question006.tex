...
\begin{parts}
    ...
    \begin{multicols}{2}
        \part Completa la Tabla \ref{tab:farmacos} en la que se calcula diariamente la cantidad de sustancia activa dentro del enfermo.\\[0.1cm]
        ...
        \part Traza la gráfica en la Figura \ref{fig:farmacos_tabla} que describe la relación de la sustancia activa con los días que pasan. ¿La gráfica es ascendente o descendente?
    ...
    % \part ¿Cuál es la razón de cambio? ¿Cómo se relaciona ésta con la constante de proporcionalidad? ¿Cuál es? Explica su obtención.
    ...
    \part Escribe una expresión algebraica que describa la situación. ¿Cuál es el valor de la pendiente y de la ordenada al origen? Describe su obtención:

    \begin{solutionbox}{2cm}

    \end{solutionbox}

    \part ¿En cuántos días la sustancia activa queda totalmente eliminada del organismo del enfermo? Explica.
    ...
    \part ¿Cómo es el tiempo que permanece en el cuerpo de un paciente, una sustancia activa
    ...
    \part ¿Cómo es el tiempo que permanece en el cuerpo de un paciente, una sustancia activa de 4 mg que decae
    ...
    \part ¿Cómo es el tiempo que permanece en el cuerpo de un paciente, una sustancia activa de 8 mg que decae 1 mg
    ...
    % \part ¿Cómo es la razón de cambio de una sustancia activa de 8 mg en el cuerpo humano que decae 0.5 mg cada medio día con
    ...
    % \part ¿Cómo es la razón de cambio de una sustancia activa de 8 mg en el cuerpo humano que decae 1 mg cada dos días
    ...
    \part Ordena las sustancias de mayor (5) a menor (1) según el tiempo que permanecen en el cuerpo humano.
