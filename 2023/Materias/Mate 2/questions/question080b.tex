\question Ordena los prismas rectos de menor a mayor volumen. La imagen muestra las bases de los cuerpos.
\begin{center}
    \dashedbox{\includegraphics[width=0.8\textwidth ]{../images/sinma2_aiu3_ac80_img08}}
\end{center}
\begin{itemize}
