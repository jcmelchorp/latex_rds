\question Se quieren fabricar jarras con formas de prisma recto cuya base sea un
...
\begin{parts}
    \part ¿Qué altura debe tener la jarra con base de hexágono regular para que pueda
    contener 1.1 L, si el lado del hexágono es de 4.6 cm y la apotema es de 4 cm?

    \begin{solutionbox}{1.7cm}
        1.1 L = 1.1 dm = 1 100 cm.

        Luego, el área del hexágono es 55.2 cm.
        Así, la altura es $1100 \div 55.2 = 19.93$ cm.
    \end{solutionbox}

    \part ¿Qué capacidad, en litros, tiene la jarra cuya base es un octágono regular de lado 4.2 cm, apotema 5 cm y altura de 21 cm?
    ...
    \part ¿Cuál es la altura de la jarra cuya base es un octágono regular con las medidas
