...
\begin{questions}
    ...
    \ejemplosboxed[{Escribe los términos faltantes de las siguientes sucesiones cuadráticas:
                \begin{multicols}{2}
                    \begin{parts}
                        \part {\large $5,12,21,$ \fillin[][0.5cm],\fillin[][0.5cm],\fillin[][0.5cm], \dots}

                        \begin{solutionbox}{4cm}
                            }
                        \end{solutionbox}

                        \part {\large $-5,-8,-9,$ \fillin[][0.5cm],\fillin[][0.5cm],\fillin[][0.5cm], \dots}
    ...
    \ejemplosboxed[{En los siguientes triángulos rectángulos, calcula el lado $x$ que falta:
                \begin{multicols}{2}
                    \begin{parts}
                        \part \includegraphics[width=0.6\linewidth]{mex_0061.png} $x=$\fillin[][0cm]

                        \begin{solutionbox}{3cm}
                        \end{solutionbox}

                        \part \includegraphics[width=0.6\linewidth]{mex_0057.png} $x=$\fillin[][0cm]
