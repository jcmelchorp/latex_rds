...
\begin{questions}
      ...
      \question[4]{Determina la mediana y la moda en los siguientes conjuntos de datos:
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[3]{Encuentra el perímetro y el área de las siguientes figuras:
            \begin{multicols}{3}
                  \begin{parts}
      ...
      \question[5]{ Observa la siguiente figura:
      ...
      \question[3]{Escribe la ecuación de las recta para dada uno de los siguientes incisos:
            \begin{parts}
      ...
      \question[3]{Resuelve las siguientes ecuaciones lineales
            \begin{multicols}{3}
                  \begin{parts}
      ...
      \question[7]{Escribe la expresión algebraica correcta para los siguientes enunciados
            \begin{multicols}{2}
                  \begin{parts}
      ...
      \question[4]{Utilizando el m\'etodo de tu preferencia, encuentra el valor de $x$ y $y$ para
