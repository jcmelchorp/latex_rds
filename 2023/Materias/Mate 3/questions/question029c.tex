\begin{minipage}[t][][t]{0.6\textwidth}
    ...
    \begin{parts}
        \part ¿Qué expresión representa el crecimiento teórico?
        ...
        \part ¿Qué expresión describe el crecimiento experimental?
        ...
        \part ¿En qué tiempo las expresiones de crecimiento tendrán el mismo valor?

        \begin{solutionbox}{1.2cm}

        \end{solutionbox}

        \part la expresión para aproximar la longitud dependiendo del tiempo, ¿es una ecuación o una identidad? ¿Por qué?
