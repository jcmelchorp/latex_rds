...
\chead{}
\rhead{\fontsize{16}{18}\selectfont \sffamily
...
\chead{\fontsize{24}{32}\selectfont \sffamily Matemáticas 1}
\studentlist{1° de Secundaria}
\newpage
\chead{}
\chead{\fontsize{24}{32}\selectfont \sffamily Matemáticas 2}
\studentlist{2° de Secundaria}
\newpage
\chead{}
\chead{\fontsize{24}{32}\selectfont \sffamily Matemáticas 3}
\studentlist{3° de Secundaria}
\newpage
\chead{}
\chead{\fontsize{24}{32}\selectfont \sffamily Física 2}
\studentlist{2° de Secundaria}
\newpage
\chead{}
\chead{\fontsize{24}{32}\selectfont \sffamily Química 3}
\studentlist{3° de Secundaria}
